...
plt.grid()
plt.savefig("trayectoria_xy_"+str(kalpha[0])+"_"+str(kalpha[1]))+".png", format='png', bbox_inches='tight', transparent=True)
...
plt.savefig('trayectoria3D_'+str(kalpha[0])+"_"+str(kalpha[1]))+'.png',format ='png', transparent=True)
